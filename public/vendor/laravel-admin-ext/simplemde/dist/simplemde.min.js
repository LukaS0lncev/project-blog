...
// at http://marijnhaverbeke.nl/blog/#cm-internals .
        ...
        (function(mod) {
                ...
                if (items) {
                    ...
                    for (var i = 0; i < items.length; i++) {
                        if (items[i].type.indexOf("image") !== -1) {
                            ...
                            var image_name = getRandomString(5) + ".png";
                            formData.append("image", file, image_name);
                            xmlhttp.open("POST", cm.options.blogImagePaste, true);
                            ...
                            xmlhttp.onreadystatechange = function() {
                                if(xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                                    try {
                                        ...
                                        if(res.url) {
                                            cm.replaceSelection("![" + (res.name || file.name) + "](" + res.url + ")");
                                        }
                                    } catch (e) {
                                        cm.replaceSelection("![]()");
                                    }
            ...
            function onDrop(e) {
                ...
                e.preventDefault();
                var url = cm.options.blogFileUpload;
                var file;
                var formData = new FormData();
                var xmlhttp = new XMLHttpRequest();
                if (e.dataTransfer.items) {
                    ...
                    for (var i = 0; i < e.dataTransfer.items.length; i++) {
                        // Если упавшие предметы не являются файлами, отклоните их
                        ...
                        if(xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                            try {
                                ...
                                $.each(res, function( key, r ){
                                    if(r.url) {
                                        cm.replaceSelection("[" + (r.name || file.name) + "](" + r.url + ")\n");
                                    }
                                });
                    ...
                    // Используйте интерфейс DataTransfer для доступа к файлу (файлам)
                    //for (var i = 0; i < e.dataTransfer.files.length; i++) {
                      //  console.log('2 ondrop ... file[' + i + '].name = ' + e.dataTransfer.files[i].name);
                    //}
                //}
                ...
                // Это может быть потеря файла, и в этом случае мы просто извлекаем текст
                // и вставьте его.
            ...
            option("blogImageUpload", "/admin/upload/blog/image");
            option("blogImagePaste", "/admin/upload/blog/image/paste");
            option("blogFileUpload", "/admin/upload/blog/file");
...
// Saved overflow setting
        ...
        function uploadImage(editor) {
            ...
            _html.setAttribute("multiple", "true");
            ...
            _input.onchange = function() {
                ...
                var url = editor.options.blogImageUpload;
                var file;
                var formData = new FormData();
                var xmlhttp = new XMLHttpRequest();

                $.each(_input.files, function( key, image ){
                ...
                xmlhttp.onreadystatechange = function() {
                    if(xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        try {
                            ...
                            $.each(res, function( key, r ){
                                if(r.url) {
                                    editor.codemirror.replaceSelection("![" + (r.name || file.name) + "](" + r.url + ")\n");
                                }
                            });
...
// Safari, in Private Browsing Mode, looks like it supports localStorage but all calls to setItem throw QuotaExceededError. We're going to detect this and set a variable accordingly.
        ...
        //SimpleMDE.prototype.pasteImage = function() {
            //pasteImage(this);
        //};
